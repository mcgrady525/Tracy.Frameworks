...
{
    /// <summary>
    /// 调试日志返回说明,必填字段：Message,Detail,Source,SystemCode
    /// </summary>
    public class DebugLogInfo : LogInfoBase
    {
        ...
        public DebugLogInfo()
        {
            ...
            Url = ConfigurationManager.AppSettings["Log.Service.Url"] + "/DebugLog/AddLog";
